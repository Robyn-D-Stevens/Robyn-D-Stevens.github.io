...
🔗 <a href="https://github.com/Robyn-D-Stevens/GOTS-Car-Maintenance-App-APDP1">GOTS Car Rental App</a><br>
...
🔗 <a href="https://github.com/Robyn-D-Stevens/MySQL-for-CPUT_Stays">CPUT Stays Repo (MySQL Base)</a><br>
...
Regarding GitHub Pages, it was fairly simple to deploy to and do in markdown. The only issues I had were figuring out the heading repetition, tables and formatting so that the page would look better and feel more like a CV given the assignment. However, I managed to figure it out and get everything needed into it per the brief. Learning Markdown has refreshed my knowledge of HTML tags and structure, given that I had to use it to add some tables that conflicted with some of my formatting and text. I managed to pull what I wanted off and it looks decent and different from what I have seen most students doing thanks to free information on the internet.
